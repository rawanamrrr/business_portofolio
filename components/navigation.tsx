...
export function Navigation() {
  ...
  return (
    <nav
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${isScrolled ? "py-2" : "py-4"
        }`}
    >
      <div
        className={`mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 transition-all duration-500 ${isScrolled
      ...
      >
        <div className="flex items-center gap-4 py-3">
          ...
          <div className="hidden md:flex items-center gap-2 rounded-full border border-border/40 bg-white px-4 py-2 text-muted-foreground shadow-sm dark:border-white/10 dark:bg-white/5 dark:text-muted-foreground ml-18">
